...
### Assumptions
- HealthForge user base: ~1000 active users (assumption based on $1,500/mo pricing and healthcare market)
...
- 600 HealthForge users × ~2.7 avg patients per calendar slot affected by errors
...
- Reasoning:
  - 80% of HealthForge users are in healthcare (platform focus)
...
- Reasoning:
  ...
  - Competitive differentiation (HealthForge = healthcare platform)
- Significant productivity win + differentiation

**Confidence: 80%**
- Reasoning:
  - We KNOW healthcare is HealthForge focus
